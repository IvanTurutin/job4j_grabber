...
public class SimpleMenu implements Menu {
    ...
    public boolean add(String parentName, String childName, ActionDelegate actionDelegate) {
        ...
        if (parentName == Menu.ROOT) {
            ...
            Optional<ItemInfo> optII = findItem(parentName);
            if (optII.isPresent()) {
                rslt = optII.get().menuItem.addChildren(new SimpleMenu.SimpleMenuItem(childName, actionDelegate));
            }
        }
        return rslt;
    }
    ...
    private class MenuItemInfoIterator implements Iterator<MenuItemInfo> {
        ...
        public boolean hasNext() {
            return itemInfoIterator.hasNext();
        }
